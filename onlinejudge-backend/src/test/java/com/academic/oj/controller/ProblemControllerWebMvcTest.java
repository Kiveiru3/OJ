...
class ProblemControllerWebMvcTest {
    ...
    void getProblemListShouldReturnPagedData() throws Exception {
        ...
        when(problemService.getProblemList(1, 10, null, null, false)).thenReturn(pageData);
    ...
    void getProblemListShouldNormalizePagingAndHiddenFlag() throws Exception {
        when(problemService.getProblemList(org.mockito.ArgumentMatchers.anyInt(),
        ...
        verify(problemService).getProblemList(pageCaptor.capture(), sizeCaptor.capture(),
